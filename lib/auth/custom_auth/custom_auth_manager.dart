...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    atos8AuthUserSubject.add(
      Atos8AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<Atos8AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  Atos8AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = Atos8AuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    atos8AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
  ...
  Future initialize() async {
    ...
    try {
      ...
      userData = _prefs.getString(_kUserDataKey) != null
          ? LoginDataTypeStruct.fromSerializableMap(
